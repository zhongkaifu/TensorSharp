...
with (root/"full_f64-benchmark-build.log").open("w") as log:
 ...
 link.insert(1,str(root/"full_f64-candidate-bench.o"))
 link[link.index("-o")+1]=str(root/"full_f64-benchmark")
 run(link)
