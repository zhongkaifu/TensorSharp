...
with (root/"kahan-benchmark-build.log").open("w") as log:
 ...
 link.insert(1,str(root/"kahan-candidate-bench.o"))
 link[link.index("-o")+1]=str(root/"kahan-benchmark")
 run(link)
