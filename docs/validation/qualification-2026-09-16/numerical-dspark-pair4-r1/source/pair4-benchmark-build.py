...
with (root/"pair4-benchmark-build.log").open("w") as log:
 ...
 link.insert(1,str(root/"pair4-candidate-bench.o"))
 link[link.index("-o")+1]=str(root/"pair4-benchmark")
 run(link)
