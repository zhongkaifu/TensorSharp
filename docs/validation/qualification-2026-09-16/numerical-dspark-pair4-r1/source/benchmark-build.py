...
with (root/"benchmark-build.log").open("w") as log:
 ...
 link.insert(1,str(root/"candidate-bench.o"))
 link[link.index("-o")+1]=str(root/"benchmark")
 run(link)
