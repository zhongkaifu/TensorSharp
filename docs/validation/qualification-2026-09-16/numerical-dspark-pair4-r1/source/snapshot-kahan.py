...
identity={"recorded_utc":datetime.datetime.now(datetime.timezone.utc).isoformat(),"source_directory":str(root),"upstream_revision":"456172ec733a135778adcd32d00e576a58232e45","binaries_sha256":{p.name:hashlib.sha256(p.read_bytes()).hexdigest() for p in root.iterdir() if p.suffix==".so" or p.name in ("kahan-benchmark","kahan-precision-test")},"release_qualified":False,"remaining_original_failure":"See retained failed_checks in kahan-prefix1-17/report.json"}
