...
| Qwen-Image-2.1 | [qwenimage21.md](qwenimage21.md) | [Abiray/Qwen-Image-2.1-GGUF](https://huggingface.co/Abiray/Qwen-Image-2.1-GGUF) | `QwenImageModel` | `qwen_image`, `qwen-image` | Text-to-image and image edit | No | No | Serialized diffusion requests | Qwen3-VL-8B conditioning, dedicated 2.1 VAE, FlowMatch-Euler, unmerged LoRA plug-ins (`--lora`) |
