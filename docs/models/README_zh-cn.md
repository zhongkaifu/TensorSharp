...
| Qwen-Image-2.1 | [qwenimage21_zh-cn.md](qwenimage21_zh-cn.md) | [Abiray/Qwen-Image-2.1-GGUF](https://huggingface.co/Abiray/Qwen-Image-2.1-GGUF) | `QwenImageModel` | `qwen_image`、`qwen-image` | 文生图与图像编辑 | 否 | 否 | 扩散请求串行执行 | Qwen3-VL-8B 条件编码、专用 2.1 VAE、FlowMatch-Euler、不合并的 LoRA 插件（`--lora`） |
