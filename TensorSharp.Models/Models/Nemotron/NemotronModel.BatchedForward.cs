...
namespace TensorSharp.Models
{
    public partial class NemotronModel : IBatchedPagedModel
    {
        ...
        public IReadOnlyList<float[]> ForwardBatch(BatchedForwardContext ctx)
        {
            ...
            // The executor passes the batch's input tokens explicitly: decode
            // steps forward the sampled-but-not-yet-committed token, which is
            // absent from the sequence's token list (TokenAt would throw).
            int[] flatTokens;
